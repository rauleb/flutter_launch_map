...
[![pub package](https://img.shields.io/badge/pub-0.2.0-blue.svg)](https://pub.dartlang.org/packages/flutter_launch_map)

## Installation

First, add flutter_launch_map_whatsapp as a dependency in your pubspec.yaml file.
